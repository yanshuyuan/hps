...
hps: logger.o mime_types.o reply.o request_parser.o request_handler.o connection.o server.o main.o request.o file_cache.o
	g++ -o hps -Wall -ansi main.o logger.o mime_types.o reply.o request_parser.o file_cache.o\
	 	request_handler.o connection.o server.o request.o -lboost_thread -g

main.o: main.cpp server.hpp logger.hpp file_cache.hpp
...
request_parser.o: request_parser.cpp request_parser.hpp request.hpp file_cache.hpp
...
file_cache.o: file_cache.cpp file_cache.hpp
	g++ -o file_cache.o -Wall -ansi -c file_cache.cpp -lboost_thread -g
