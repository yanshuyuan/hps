...
hps: logger.o mime_types.o reply.o request_parser.o request_handler.o connection.o server.o main.o
	g++ -o hps -Wall -ansi main.o logger.o mime_types.o reply.o request_parser.o \
	 	request_handler.o connection.o server.o -lboost_thread -g
